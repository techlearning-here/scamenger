# Missing Features (from readme_New_UX.md)

This document lists features described in **readme_New_UX.md** that are **not yet implemented** or only **partially implemented**. Use it for prioritization and sprint planning.
...
| **Estimated time to report** | **Missing** | No **"~5 min"** (or similar) labels next to reporting links or steps. |

**To implement:** (1) Define a source for "most reported" / "trending" (e.g. from admin stats or manual list) and render badges on cards/links. (2) Add optional `estimatedMinutes` (or similar) to reporting links or wizard steps and show e.g. "~5 min" next to each.
...
| Mobile | Country auto-detection | Missing |
| Nav | "Need help now?" sticky CTA | Missing |
...
| Content | Estimated time to report (~5 min) | Missing |

---

*Generated from readme_New_UX.md. Update this list as features are implemented.*
