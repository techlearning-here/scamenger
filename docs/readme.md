...
You can add a clear note that your site helps people find official channels to report.
...
- **Sitemap:** The site generates a sitemap at `https://scamenger.com/sitemap.xml` (referenced in generated `robots.txt`). Submit this URL in [Google Search Console](https://search.google.com/search-console) (Sitemaps) and in Bing Webmaster Tools so search engines can discover and index your pages.
