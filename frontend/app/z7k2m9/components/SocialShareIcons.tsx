...
/** Facebook "f" logo for Share to Facebook button. */
...
/** External link (open in new tab) for "View full report" and similar links. */
...
/** Globe icon for "View as public" (public-facing report view). */
...
/** Checkmark icon for Approve button. */
...
/** X in circle for Reject button. */
export function RejectIcon({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** Copy to clipboard icon for report ID. */
...
/** Pencil/edit icon for Edit report button. */
...
/** Link/chain icon to flag reports that have external evidence links. */
