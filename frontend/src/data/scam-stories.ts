...
export const SCAM_STORY_ENTRIES: ScamStoryEntry[] = [
  ...
  { slug: 'lpg-payment-pending-link-phone-hijacked', title: '"LPG payment pending"—one click, and my phone was hijacked and money from my bank account was gone', category: 'online' },
