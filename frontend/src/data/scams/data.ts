import type { UsScamType } from './types';

export const US_SCAMS: UsScamType[] = [
  {
    slug: 'phishing',
    ...
    relatedSlugs: ['smishing', 'business-email-compromise', 'tech-support'],
    faq: [
      { question: 'What if I already clicked the link?', answer: 'Do not enter any information. Close the tab, run a security scan if you have antivirus software, change your password for that account (using the real site, not a link from the email), and report the phishing attempt to the FTC and IC3.' },
      { question: 'How can I tell if an email is really from my bank?', answer: 'Check the sender address carefully—scammers often use lookalike domains. Do not click links in the email; instead, open your browser and type your bank\'s URL yourself, or use the bank\'s official app, and check your account or messages there.' },
    ],
    learnMore: [
      { label: 'FTC: How to recognize and report phishing', href: 'https://consumer.ftc.gov/articles/how-recognize-and-report-phishing' },
      { label: 'CISA: Avoid social engineering and phishing', href: 'https://www.cisa.gov/news-events/news/avoid-social-engineering-and-phishing-attacks' },
    ],
  },
  {
    slug: 'smishing',
    ...
    faq: [
      { question: 'What if I already clicked a link in the text?', answer: 'Do not enter any information. If you entered payment or account details, contact your bank or card issuer immediately. Change passwords for any accounts you may have used. Report the message to the FTC and IC3.' },
      { question: 'How do I report a scam text?', answer: 'Forward the text to 7726 (SPAM). Save a screenshot and note the number and date. Then report to the FTC at reportfraud.ftc.gov and to IC3 if you lost money or shared sensitive info.' },
    ],
    learnMore: [
      { label: 'FTC: Text message scams', href: 'https://consumer.ftc.gov/articles/text-message-scams' },
    ],
  },
  {
    slug: 'fake-shopping',
    ...
    relatedSlugs: ['phishing', 'prize-sweepstakes-lottery', 'pet-adoption-scam'],
    faq: [
      { question: 'I paid but never got my order. What do I do?', answer: 'Stop any further payments. Dispute the charge with your bank or card issuer. Report the seller and transaction to the FTC and IC3 with order details, screenshots, and any messages.' },
      { question: 'Someone overpaid me by check and wants a refund. Is that a scam?', answer: 'Yes. The check will bounce. Do not wire or send any money back. Report to the FTC and your bank.' },
    ],
    learnMore: [
      { label: 'FTC: Online shopping', href: 'https://consumer.ftc.gov/articles/online-shopping' },
    ],
  },
  {
    slug: 'tech-support',
    ...
    faq: [
      { question: 'A pop-up says my computer is infected. What do I do?', answer: 'Close the browser or restart the computer. Do not call any number on the pop-up. Run a scan with your own antivirus if you have one. Report the pop-up to the FTC and IC3.' },
      { question: 'I already gave remote access. What now?', answer: 'Disconnect from the internet, run a full antivirus scan, and change important passwords (on another device). Monitor accounts and report to the FTC and IC3 with any details you have.' },
    ],
    learnMore: [
      { label: 'FTC: Tech support scams', href: 'https://consumer.ftc.gov/articles/tech-support-scams' },
      { label: 'Microsoft: Avoid tech support scams', href: 'https://support.microsoft.com/en-us/windows/stay-protected-from-tech-support-scams-0e5ad900-646b-4d6e-a84f-59e7e33f18f4' },
    ],
  },
  {
    ...
    relatedSlugs: ['phishing', 'romance', 'bank-zelle-transfer'],
    faq: [
      { question: 'We already sent a wire. What do we do?', answer: 'Contact your bank immediately to try to recall or freeze the transfer. Notify your IT team to secure email and other systems. Report to the FBI IC3 with full details including email headers and transaction info.' },
      { question: 'How can we prevent BEC?', answer: 'Verify any payment or data request through a separate channel (phone call to a known number). Use multi-factor authentication and train staff to spot spoofed or suspicious emails.' },
    ],
    learnMore: [
      { label: 'FBI: Business email compromise', href: 'https://www.ic3.gov/Media/PDFs/AnnualReport/2023_IC3Report.pdf' },
    ],
  },
  {
    slug: 'extortion',
    ...
    faq: [
      { question: 'They have my password. Does that mean they have my data?', answer: 'Not necessarily. They often use passwords from old data breaches to scare you. Change the password everywhere you use it and enable two-factor authentication. Do not pay.' },
      { question: 'What if I already paid?', answer: 'Stop paying. Report to the FBI IC3 and FTC. Block the contact. You may be able to dispute the payment with your bank or card issuer depending on how you paid.' },
    ],
    learnMore: [
      { label: 'FTC: Sextortion and blackmail', href: 'https://consumer.ftc.gov/articles/what-know-about-sextortion' },
    ],
  },
  {
    ...
    relatedSlugs: ['fake-shopping', 'bank-zelle-transfer'],
    faq: [
      { question: 'I was charged after a free trial and can\'t cancel. What do I do?', answer: 'Try to cancel through the company\'s website or customer service and keep proof. Dispute unauthorized or recurring charges with your bank or card issuer. Report to the FTC and your state Attorney General.' },
      { question: 'Are free trial offers always scams?', answer: 'Not all are scams, but many use fine print to charge you after the trial or make cancellation hard. Always check terms and how to cancel before entering your payment info.' },
    ],
    learnMore: [
      { label: 'FTC: Free trial offers', href: 'https://consumer.ftc.gov/articles/free-trial-offers' },
    ],
  },
  // —— Phone & mail ——
  {
    ...
    statistics: ['Billions of robocalls are placed each year; many are illegal or fraudulent.', 'Caller ID can be spoofed—the number you see may not be the real caller.'],
    relatedSlugs: ['irs-tax-impersonation', 'government-imposter', 'family-emergency-grandparent'],
    faq: [
      { question: 'They said I had to press 1 to stop the calls. Should I?', answer: 'No. Pressing a number often confirms your number is active and can lead to more calls or a live scammer. Hang up and report the number to the FTC and FCC.' },
      { question: 'The caller ID showed my bank. Was it really them?', answer: 'Caller ID can be spoofed. Do not give personal or payment info. Hang up and call your bank using the number on your card or statement.' },
    ],
    learnMore: [
      { label: 'FTC: Robocalls', href: 'https://consumer.ftc.gov/articles/robocalls' },
      { label: 'FCC: Stop unwanted calls', href: 'https://www.fcc.gov/consumers/guides/stop-unwanted-robocalls-and-texts' },
    ],
  },
  // —— Financial & banking ——
  {
    ...
    faq: [
      { question: 'I sent money via Zelle to a scammer. Can I get it back?', answer: 'Zelle and similar apps often do not offer the same fraud protections as credit cards. Contact your bank immediately and report to the CFPB and IC3. Recovery is not guaranteed, but reporting helps investigations.' },
      { question: 'Someone I don\'t know sent me money and wants it back. What do I do?', answer: 'Do not send it back. It may be a stolen account or fake payment. Contact your bank and report the situation. Do not wire or send money to the requester.' },
    ],
    learnMore: [
      { label: 'CFPB: Sending money', href: 'https://www.consumerfinance.gov/consumer-tools/send-money/' },
      { label: 'FTC: Payment apps', href: 'https://consumer.ftc.gov/articles/what-know-about-using-payment-apps-and-digital-wallets' },
    ],
  },
  {
    ...
    relatedSlugs: ['pig-butchering', 'pump-dump-social-group', 'fake-loans'],
    faq: [
      { question: 'The platform says I need to pay "tax" or "fees" to withdraw. Is that normal?', answer: 'No. Legitimate platforms do not require you to pay more to withdraw your own money. This is a common tactic to get you to send more. Stop paying and report to the SEC, FTC, and IC3.' },
      { question: 'How can I check if an investment opportunity is legitimate?', answer: 'Search the SEC\'s EDGAR database and your state securities regulator. Check for registration and any enforcement actions. Be skeptical of "guaranteed" returns or pressure to act quickly.' },
    ],
    learnMore: [
      { label: 'SEC: Investor alerts', href: 'https://www.sec.gov/oiea/investor-alerts-and-bulletins' },
      { label: 'FTC: Investment scams', href: 'https://consumer.ftc.gov/articles/how-avoid-investment-scams' },
    ],
  },
  {
    slug: 'pig-butchering',
    ...
    relatedSlugs: ['romance', 'investment-crypto', 'pump-dump-social-group'],
    faq: [
      { question: 'I think I am in a pig butchering scam. What do I do?', answer: 'Stop sending any money. Do not pay "fees" or "tax" to withdraw—you will not get your money back that way. Save all chats, platform URLs, wallet addresses, and transaction IDs. Report to the FBI IC3 and FTC.' },
      { question: 'Can I get my money back?', answer: 'Recovery is difficult because funds are often moved quickly and overseas. Reporting to IC3 and the FTC helps law enforcement and may help in some cases. Never pay more in the hope of "unlocking" funds.' },
    ],
    learnMore: [
      { label: 'FBI: Pig butchering fraud', href: 'https://www.ic3.gov/Media/PDFs/PublicServiceAnnouncements/Pig_Butchering_PSA.pdf' },
      { label: 'FTC: Romance scams', href: 'https://consumer.ftc.gov/articles/what-you-need-know-about-romance-scams' },
    ],
  },
  {
  ...
  // —— Impersonation ——
  {
    ...
    relatedSlugs: ['government-imposter', 'robocalls-phone', 'utility-shutoff-scam'],
    faq: [
      { question: 'They said I\'d be arrested if I don\'t pay. Is that real?', answer: 'No. The IRS does not threaten arrest in a single call. They contact by mail first. Hang up and report the call to the IRS (irs.gov/phishing) and the FTC.' },
      { question: 'How does the real IRS contact people?', answer: 'The IRS typically contacts by mail first. They do not demand immediate payment by gift card, wire, or crypto. If you owe taxes, you will get a letter with instructions.' },
    ],
    learnMore: [
      { label: 'IRS: How to know it’s really the IRS', href: 'https://www.irs.gov/newsroom/how-to-know-it-is-really-the-irs-calling-or-knocking-on-your-door' },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ['pig-butchering', 'family-emergency-grandparent', 'extortion'],
    faq: [
      { question: 'We video chatted. Does that mean they are real?', answer: 'Scammers sometimes use pre-recorded video or short live calls. If they avoid meeting in person, make excuses, or ask for money, treat it as a scam. Do not send money.' },
      { question: 'I already sent money. What do I do?', answer: 'Stop sending more. Report to the FTC and IC3 with usernames, platform, and payment details. Contact your bank or payment app—you may be able to dispute some transfers. Block the person.' },
    ],
    learnMore: [
      { label: 'FTC: Romance scams', href: 'https://consumer.ftc.gov/articles/what-you-need-know-about-romance-scams' },
      { label: 'FBI: Romance scams', href: 'https://www.ic3.gov/Media/PDFs/PublicServiceAnnouncements/PSA_Romance_Scams.pdf' },
    ],
  },
  {
  ...
  // —— Employment & opportunity ——
  {
    ...
    faq: [
      { question: 'They sent me a check and asked me to wire part of it. Is that a scam?', answer: 'Yes. The check will bounce. Real employers do not send you a check and ask you to send part of it elsewhere. Report to the FTC and your bank.' },
      { question: 'How can I tell if a job posting is real?', answer: 'Search the company name and contact them through official channels (website, phone from their site)—not only the email in the ad. Be wary of jobs that require payment or moving money.' },
    ],
    learnMore: [
      { label: 'FTC: Job scams', href: 'https://consumer.ftc.gov/articles/job-scams' },
    ],
  },
  // —— Housing & rental ——
  {
    ...
    relatedSlugs: ['fake-shopping', 'job-employment', 'fake-tenant-screening'],
    faq: [
      { question: 'The landlord says they are out of town. Can I still rent?', answer: 'Be very careful. Verify the owner through county property records or the building management. Do not wire money before you have seen the property and have a signed lease. Many scams use the "owner is away" story.' },
      { question: 'I already sent money for a rental that turned out to be fake. What do I do?', answer: 'Report to the FTC and IC3 with the listing, contact details, and amount paid. Contact your bank if you wired money—they may be able to help. File a report with local police if you have an address.' },
    ],
    learnMore: [
      { label: 'FTC: Rental listing scams', href: 'https://consumer.ftc.gov/articles/rental-listing-scams' },
    ],
  },
  {
  ...
  // —— Identity & benefits ——
  {
    ...
    relatedSlugs: ['phishing', 'student-loan', 'irs-tax-impersonation'],
    faq: [
      { question: 'What is the first step if I think my identity was stolen?', answer: 'Go to IdentityTheft.gov. You can report and get a personalized recovery plan. Place a fraud alert or freeze with the credit bureaus and close any accounts you did not open.' },
      { question: 'Should I place a fraud alert or a credit freeze?', answer: 'A fraud alert notifies creditors to verify your identity before opening new accounts. A freeze blocks access to your credit report so new accounts cannot be opened. Both are free. IdentityTheft.gov explains how to do each.' },
    ],
    learnMore: [
      { label: 'IdentityTheft.gov – Report and recover', href: 'https://identitytheft.gov/' },
      { label: 'FTC: Identity theft', href: 'https://consumer.ftc.gov/identity-theft-and-identity-fraud' },
    ],
  },
  {
    slug: 'student-loan',
